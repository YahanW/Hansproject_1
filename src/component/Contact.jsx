...
const Contact = () => {
  ...
  return (
    <div name='contact' className={value ? 'w-full h-screen flex justify-center items-center p-4':
    'w-full h-screen bg-[#16162c] flex justify-center items-center p-4'}>
          <form method='POST' action='https://getform.io/f/2c275de6-f52c-486c-979d-4d5faec3eccc' className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className={value? 'text-4xl font-bold inline border-b-4 border-pink-600 text-black':
                'text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300'}>Contact</p>
